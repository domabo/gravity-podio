...
class GFPodioData{
    ...
    public static function update_table(){
        global $wpdb;
        $table_name = self::get_podio_table_name();
    ...
    public static function get_podio_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_podio";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_podio_table_name());
    }
}